...
{
    private readonly IBeneficiarioServicio _servicio;

    public BeneficiariosController(IBeneficiarioServicio servicio)
    {
        _servicio = servicio;
    }

    [HttpGet]
    [ProducesResponseType(typeof(IReadOnlyList<BeneficiarioDto>), StatusCodes.Status200OK)]
    ...
    [HttpGet("{id:guid}")]
    [ProducesResponseType(typeof(BeneficiarioDto), StatusCodes.Status200OK)]
    ...
    [HttpPost]
    [ProducesResponseType(typeof(BeneficiarioDto), StatusCodes.Status201Created)]
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<IActionResult> Actualizar(Guid id, [FromBody] ActualizarBeneficiarioDto dto)
    {
