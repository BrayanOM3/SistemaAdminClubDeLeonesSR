...
[ApiController]
[Route("api/v1/donaciones")]
[Authorize]
public class DonacionesController : ControllerBase
{
    private readonly IDonacionServicio _servicio;

    public DonacionesController(IDonacionServicio servicio)
    {
        _servicio = servicio;
    }
    ...
    [HttpGet("{id:guid}")]
    [ProducesResponseType(typeof(DonacionDto), StatusCodes.Status200OK)]
    ...
    [HttpPost]
    [ProducesResponseType(typeof(DonacionDto), StatusCodes.Status201Created)]
    ...
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    public async Task<IActionResult> Actualizar(Guid id, [FromBody] ActualizarDonacionDto dto)
    {
